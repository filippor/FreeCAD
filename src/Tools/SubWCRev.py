...
def main():
    ...
    for i in vcs:
        if i.extractInfo(srcdir, bindir):
            ...
            lines = inp.readlines()
            inp.close()
            ####lines = i.writeVersion(lines) # this source package already has git info, we do nothing here # this source package already has git info, we do nothing here # this source package already has git info, we do nothing here # this source package already has git info, we do nothing here
