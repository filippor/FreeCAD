...
using DSHTextController =
    DrawSketchDefaultWidgetController<DrawSketchHandlerText,
...
private:
    ...
    void executeCommands() override
    {
        try {
            ...
            if (!addListConstraint(getSketchObject(),
                                   elts,
                                   "Text",
                                   startPoint,
                                   endPoint,
...
private:
    ...
    void createShape(bool onlyeditoutline) override
    {
        ...
        transformAndConvertToGeometry(ShapeGeometry,
                                      cachedBaseShapes,
...
void DSHTextController::configureToolWidget()
{
    if (!init) {  // Code to be executed only upon initialisation
        ...
        toolWidget->setComboboxLabel(WCombobox::SecondCombo,
...
std::list<Gui::InputHint> DrawSketchHandlerText::lookupTextHints(int method, int state)
{
    ...
    auto it = std::find_if(TextHintTable.begin(),
                           TextHintTable.end(),
