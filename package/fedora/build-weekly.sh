#! /bin/sh -x
SOURCE_URL=https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/weekly-builds/freecad_source.tar.gz
...
curl -O --location --retry 3 https://raw.githubusercontent.com/filippor/FreeCAD/refs/heads/copr/package/fedora/freecad-git.spec.rpkg
