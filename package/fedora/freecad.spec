...
Source0:        https://github.com/FreeCAD/FreeCAD-Bundle/releases/download/1.0.0/freecad_source.tar.gz
...
# Removed bundled liAddonManagerbraries
...
%endif
       ...
       -DPACKAGE_WCURL="git://github.com/%{git_name}/FreeCAD.git main" \
