...
VCS:            https://github.com/FreeCAD/FreeCAD.git

Source0:        https://github.com/FreeCAD/FreeCAD/archive/refs/tags/%version.zip
...
%global _vpath_srcdir  %_builddir/FreeCAD-%version
...
%build
    ...
    %endif
        -DPACKAGE_WCREV="1.0.0" \
        -DPACKAGE_WCURL="https://github.com/FreeCAD/FreeCAD.git"\
    %if %{with tests}
    ...
    sed -i -e 's|"$WCREV$"|"1.0.0"|g' %_vpath_builddir/src/Build/Version.h.in
    sed -i -e 's|"$WCURL$"|"https://github.com/FreeCAD/FreeCAD.git"|g'              %_vpath_builddir/src/Build/Version.h.in
